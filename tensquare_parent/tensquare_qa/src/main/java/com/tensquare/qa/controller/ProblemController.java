   ...
   @RequestMapping(value  ="/newlist/{labelid}/{page}/{size}",method = RequestMethod.GET)
	public  Result newList(@PathVariable String labelid,@PathVariable int page,@PathVariable int size){
	   Page<Problem> newList = problemService.newList(labelid, page, size);
		...
		return  new Result(true,StatusCode.OK,"最新问题列表查询成功",newList);
	}
	...
	public  Result hotList(@PathVariable String labelid,@PathVariable int page,@PathVariable int size){
		...
		return  new Result(true,StatusCode.OK,"最热问题列表查询成功",hotList);
	...
	public  Result waitList(@PathVariable String labelid,@PathVariable int page,@PathVariable int size){
		...
		return  new Result(true,StatusCode.OK,"最热问题列表查询成功",waitList);
