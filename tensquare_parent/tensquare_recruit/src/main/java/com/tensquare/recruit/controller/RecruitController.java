...
public class RecruitController {
	...
	public  Result  recommend(){
		...
		return  new Result(true,StatusCode.OK,"查询推荐职位信息成功",list);
	}
	@RequestMapping(value = "/search/newlist",method = RequestMethod.GET)
	public  Result newlist(){
		List<Recruit> list = recruitService.findTop6ByStateNotOrderByCreatetimeDesc("0");
		return  new Result(true,StatusCode.OK,"查询最新职位信息成功",list);
	}
	/**
	 * 查询全部数据
	 * @return
